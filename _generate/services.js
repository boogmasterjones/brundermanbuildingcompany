...
module.exports = [
...

  {
    ...
    seo: [
      'Homeowners looking for a home remodeling contractor near me in Port Charlotte usually want the same three things: someone who shows up, someone who communicates, and someone who knows what is behind the wall before they open it. After four decades and more than 800 customers, that is the reputation Brunderman Building Company has worked to earn. Our reviews mention responsiveness, punctuality, and quality for a reason. Whether you need a general contractor for a whole-house renovation or a remodeler for a few key rooms, you will deal with experienced builders from the first call.',
...

  {
    ...
    intro: [
      ...
      'At Brunderman Building Company, a kitchen remodeling project begins with how you cook and gather, not with a cabinet catalog. Do you want an island with seating or a peninsula? A view to the lanai from the sink? A pantry where the old laundry closet was? Once the layout is right, we help you choose cabinetry, countertops, tile, fixtures, and lighting that suit the house and the budget.',
    ...
    seo: [
      'When people search for kitchen remodeling near me or a kitchen remodeler in Port Charlotte FL, they are often comparing cabinet showrooms, big-box installers, and general contractors. The difference with a builder-led kitchen remodel is scope. A showroom sells cabinets. Brunderman Building Company handles the whole project — the wall that needs to come out, the plumbing that needs to move through the slab, the electrical panel that may need capacity for an induction range, and the permit and inspections that tie it together. You have one contractor responsible for the result.',
...

  {
    ...
    seo: [
      'Searching bathroom remodeling near me in Port Charlotte will turn up one-day bath-liner franchises, tile installers, and general contractors. They are not the same service. A liner covers the old tub. A tile installer tiles. Builder-led bathroom remodeling from Brunderman Building Company covers everything from the drain line in the slab to the last towel hook, under one contract and one permit. That matters most when the project involves moving a drain for a larger shower, widening a doorway, or correcting hidden water damage found during demolition.',
